...
function Button(_a) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    ...
    __spreadProps(__spreadValues({}, props), {
      className: clsx_default(baseClass, variants[variant], sizes[size], className)
    }),
    children
  );
}
...
function Card({
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", { className: `${baseClass} ${variantClasses[variant]}` }, /* @__PURE__ */ import_react2.default.createElement("h2", { className: "text-xl font-bold mb-3 tracking-tight" }, title), /* @__PURE__ */ import_react2.default.createElement("div", { className: "text-sm leading-relaxed" }, children));
}

...
function Card({
  ...
  return /* @__PURE__ */ React2.createElement("div", { className: `${baseClass} ${variantClasses[variant]}` }, /* @__PURE__ */ React2.createElement("h2", { className: "text-xl font-bold mb-3 tracking-tight" }, title), /* @__PURE__ */ React2.createElement("div", { className: "text-sm leading-relaxed" }, children));
}
